...
#define Z80_FAST_WRITE(a) (((a) >= 0xd000u && (a) <= 0xd7ffu) || (a) >= 0xe004u)
#endif
#if defined(Z80_MAP_GENESIS) && !defined(Z80_FAST_READ)
/* Sega Megadrive sound Z80:
 *   0x0000-0x1FFF RAM (mirrored to 0x3FFF), 0x4000-0x4003 YM2612,
 *   0x6000 bank register, 0x7F11 PSG, 0x8000-0xFFFF banked 68k window.
 * Only the 8KB RAM is plain memory[]; everything else (mirror included)
 * traps to machine_rd/machine_wr. The driver executes from RAM, so the
 * direct-fetch path stays valid. */
#define Z80_FAST_READ(a)  ((a) < 0x2000u)
#define Z80_FAST_WRITE(a) ((a) < 0x2000u)
#endif
